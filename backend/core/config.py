...
class Settings(BaseSettings):
    ...
    oci_vault_id: str | None = Field(default=None, alias="OCI_VAULT_ID")
    ...
    secret_provider: str = Field(default="env", alias="SECRET_PROVIDER")
    ...
    ai_max_input_findings: int = Field(default=50, alias="AI_MAX_INPUT_FINDINGS")
    ai_max_input_resources: int = Field(default=100, alias="AI_MAX_INPUT_RESOURCES")
