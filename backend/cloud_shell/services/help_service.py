...
class HelpCommand:
    def execute(self, db: Session, parsed: ParsedCommand, user_context: ShellUserContext) -> ShellResponse:
        return (
            ...
            .line("")
            .line("Apply and Outputs:")
            .line("  nb terraform apply <request_id>")
            .line("  nb outputs show <request_id>")
            .line("")
            .line("Post-Validation:")
            .line("  nb validate request <request_id>")
            .line("  nb validate finding <finding_id>")
            .line("  nb rescan account <account_id>")
            .line("  nb remediation report <request_id>")
            .line("")
            .line("Disabled:")
